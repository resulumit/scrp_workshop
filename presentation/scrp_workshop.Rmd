...
```{r eval=FALSE}
<p>This is an <`span` style="text-decoration: underline;">importnat paragraph<`/span`>, which
...
<p>This is an <span style="text-decoration: underline;">importnat paragraph</span>, which you must read carefully.<p>
