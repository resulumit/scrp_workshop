...
11) Get the fist list element on the page at <https://luzpar.netlify.app/states/>

- find the selector with the functionality Chrome offers

<br>

12) Get all list elements on the same page

- find the selector with SelectorGadget

<br>

13) Get only the second and fourth element on the list

- without repeating the code
- that is, use only a single selector that would return both list elements
...
20) Navigate to and get the source code of a page
...
21) See what other methods are available to interact with browsers
...
22) Try one or more new methods
...
23) Conduct an internet search programatically
...
24) Scroll down programatically, and up
- to see all results

<br>

25) Go back, and conduct another search
...
26) Collect data on a subset of documents
