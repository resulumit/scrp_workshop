...
install.packages(c("rvest", "robotstxt", "polite", "tidyverse", "tidytext"))
```
...
- If you cannot use Chrome or Safari
...
<br>
   ...
   - please reflect on, and check, before you scrape
...
<br>
   - it gathers data that
      - is under copyright
      - is not meant for the public to see
      - is then used for financial gain
