...
The difference occurs when there is protocol against 
...
- it is a little bit of a special case
  
  - code might look slightly unfamiliar to beginners
...
- A lot has already been written on this package
  ...
  - Google searches return code in various languages
      - not only R but also Python, Java

---
## Dynamic Pages &mdash; `Rselenium` &mdash; Starting a Server
...
- `rsDriver()` creates a client and a server
   - our code will control the client
   - client is best thought as the browser itself
   - you can give it any name &mdash; I prefer to call it `browser`
   
---
## Dynamic Pages &mdash; `Rselenium` &mdash; Navigate
...
- `navigate` is called a method, not a function
    ...
    - use the dollar sign <span style="background-color: #ffff88;">$</span> notation
...
---
## Dynamic Pages &mdash; `Rselenium` &mdash; Close and Open
...
```
---
## Dynamic Pages &mdash; `Rselenium` &mdash; Get Page Source
